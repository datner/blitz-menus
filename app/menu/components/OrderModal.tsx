    ...
    <Modal open={open} onClose={onClose}>
      <div className="p-3">
        ...
        <div>
          ...
          <button
            onClick={onOrder}
            className="inline-flex w-full justify-center items-center rounded-md border border-transparent shadow-lg shadow-indigo-300 px-4 py-4 bg-indigo-600 text-base text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
          >
